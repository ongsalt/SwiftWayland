    ...
    public enum Event: WlEventEnum {
        ...
        public static func decode(message: Message, connection: Connection, fdSource: BufferedSocket) -> Self {
            ...
            case 5:
                return Self.removed
            case 6:
                return Self.proximityIn(serial: r.readUInt(), tablet: connection.get(as: ZwpTabletV1.self, id: r.readObjectId())!, surface: connection.get(as: WlSurface.self, id: r.readObjectId())!)
            case 7:
            ...
            case 13:
                return Self.tilt(tiltX: r.readInt(), tiltY: r.readInt())
            case 14:
                return Self.rotation(degrees: r.readInt())
            case 15:
                return Self.slider(position: r.readInt())
            case 16:
                return Self.wheel(degrees: r.readInt(), clicks: r.readInt())
            case 17:
