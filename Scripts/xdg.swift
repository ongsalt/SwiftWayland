...
public enum Decoration {
    ...
    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/xdg-decoration/xdg-decoration-unstable-v1.xml", [Xdg.Shell])
    }
}
#endif
...
public enum Foreign {
    ...
    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/xdg-foreign/xdg-foreign-unstable-v1.xml", [])
    }
    
    /// Unstable version 2
    public enum ZV2 {
        // wayland_protocol!("./protocols/unstable/xdg-foreign/xdg-foreign-unstable-v2.xml", [])
    }
}
#endif

#if UNSTABLE
public enum XdgOutput {
    ...
    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/xdg-output/xdg-output-unstable-v1.xml", [])
    }
}
#endif
...
public enum Shell {
    ...
    // wayland_protocol!("./protocols/stable/xdg-shell/xdg-shell.xml", [])
}

#if STAGING
public enum ToplevelDrag {
    ...
    /// Version 1
    public enum V1 {
        // wayland_protocol!("./protocols/staging/xdg-toplevel-drag/xdg-toplevel-drag-v1.xml", [Xdg.Shell])
    }
}
#endif
...
public enum Dialog {
    ...
    /// Version 1
    public enum V1 {
        // wayland_protocol!("./protocols/staging/xdg-dialog/xdg-dialog-v1.xml", [Xdg.Shell])
    }
}
#endif
...
public enum ToplevelIcon {
    ...
    /// Version 1
    public enum V1 {
        // wayland_protocol!("./protocols/staging/xdg-toplevel-icon/xdg-toplevel-icon-v1.xml", [Xdg.Shell])
    }
}
#endif
...
public enum ToplevelTag {
    ...
    /// Version 1
    public enum V1 {
        // wayland_protocol!("./protocols/staging/xdg-toplevel-tag/xdg-toplevel-tag-v1.xml", [Xdg.Shell])
    }
}
#endif

#if STAGING
public enum SystemBell {
    /// This global interface enables clients to ring the system bell.

    /// Version 1
    public enum V1 {
        // wayland_protocol!("./protocols/staging/xdg-system-bell/xdg-system-bell-v1.xml", [])
    }
}
#endif