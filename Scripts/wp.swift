...
public enum ContentType {
    ...
    public enum V1 {
        // wayland_protocol!("./protocols/staging/content-type/content-type-v1.xml", [])
    }
}
#endif
...
public enum ColorManagement {
    ...
    public enum V1 {
        // wayland_protocol!("./protocols/staging/color-management/color-management-v1.xml", [])
    }
}
#endif
...
public enum ColorRepresentation {
    ...
    public enum V1 {
        // wayland_protocol!("./protocols/staging/color-representation/color-representation-v1.xml", [])
    }
}
#endif

#if STAGING
public enum DrmLease {
    ...
    public enum V1 {
        // wayland_protocol!("./protocols/staging/drm-lease/drm-lease-v1.xml", [])
    }
}
#endif

#if STAGING
public enum TearingControl {
    ...
    public enum V1 {
        // wayland_protocol!("./protocols/staging/tearing-control/tearing-control-v1.xml", [])
    }
}
#endif

#if STAGING
public enum FractionalScale {
    ...
    public enum V1 {
        // wayland_protocol!("./protocols/staging/fractional-scale/fractional-scale-v1.xml", [])
    }
}
#endif

#if UNSTABLE
public enum FullscreenShell {
    /// Fullscreen shell protocol

    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/fullscreen-shell/fullscreen-shell-unstable-v1.xml", [])
    }
}
#endif

#if UNSTABLE
public enum IdleInhibit {
    /// Screensaver inhibition protocol

    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/idle-inhibit/idle-inhibit-unstable-v1.xml", [])
    }
}
#endif
...
public enum InputMethod {
    ...
    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/input-method/input-method-unstable-v1.xml", [])
    }
}
#endif

#if UNSTABLE
public enum InputTimestamps {
    /// Input timestamps protocol

    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/input-timestamps/input-timestamps-unstable-v1.xml", [])
    }
}
#endif

#if UNSTABLE
public enum KeyboardShortcutsInhibit {
    ...
    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/keyboard-shortcuts-inhibit/keyboard-shortcuts-inhibit-unstable-v1.xml", [])
    }
}
#endif

public enum LinuxDmabuf {
    /// Linux DMA-BUF protocol

    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/stable/linux-dmabuf/linux-dmabuf-v1.xml", [])
    }
}

#if UNSTABLE
public enum LinuxExplicitSynchronization {
    /// Linux explicit synchronization protocol

    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/linux-explicit-synchronization/linux-explicit-synchronization-unstable-v1.xml", [])
    }
}
#endif

#if STAGING
public enum LinuxDrmSyncobj {
    ...
    /// Version 1
    public enum V1 {
        // wayland_protocol!("./protocols/staging/linux-drm-syncobj/linux-drm-syncobj-v1.xml", [])
    }
}
#endif

#if UNSTABLE
public enum PointerConstraints {
    ...
    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/pointer-constraints/pointer-constraints-unstable-v1.xml", [])
    }
}
#endif

#if UNSTABLE
public enum PointerGestures {
    /// Pointer gestures protocol

    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/pointer-gestures/pointer-gestures-unstable-v1.xml", [])
    }
}
#endif
...
public enum PresentationTime {
    ...
    // wayland_protocol!("./protocols/stable/presentation-time/presentation-time.xml", [])
}

#if UNSTABLE
public enum PrimarySelection {
    /// Primary selection protocol

    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/primary-selection/primary-selection-unstable-v1.xml", [])
    }
}
#endif

#if UNSTABLE
public enum RelativePointer {
    ...
    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/relative-pointer/relative-pointer-unstable-v1.xml", [])
    }
}
#endif

#if STAGING
public enum SinglePixelBuffer {
    ...
    /// Version 1
    public enum V1 {
        // wayland_protocol!("./protocols/staging/single-pixel-buffer/single-pixel-buffer-v1.xml", [])
    }
}
#endif
...
public enum CursorShape {
    ...
    /// Version 1
    public enum V1 {
        // wayland_protocol!("./protocols/staging/cursor-shape/cursor-shape-v1.xml", [Tablet.ZV2])
    }
}
#endif
...
public enum Tablet {
    ...
    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/tablet/tablet-unstable-v1.xml", [])
    }

    /// Unstable version 2
    public enum ZV2 {
        // wayland_protocol!("./protocols/stable/tablet/tablet-v2.xml", [])
    }
}
...
public enum TextInput {
    ...
    /// Unstable version 1
    public enum ZV1 {
        // wayland_protocol!("./protocols/unstable/text-input/text-input-unstable-v1.xml", [])
    }

    /// Unstable version 3
    public enum ZV3 {
        // wayland_protocol!("./protocols/unstable/text-input/text-input-unstable-v3.xml", [])
    }
}
#endif

public enum Viewporter {
    /// Viewporter protocol
    ///
...
public enum SecurityContext {
    ...
    public enum V1 {
        // wayland_protocol!("./protocols/staging/security-context/security-context-v1.xml", [])
    }
}
#endif
...
public enum AlphaModifier {
    ...
    public enum V1 {
        // wayland_protocol!("./protocols/staging/alpha-modifier/alpha-modifier-v1.xml", [])
    }
}
#endif
...
public enum Fifo {
    ...
    public enum V1 {
        // wayland_protocol!("./protocols/staging/fifo/fifo-v1.xml", [])
    }
}
#endif
...
public enum CommitTiming {
    ...
    public enum V1 {
        // wayland_protocol!("./protocols/staging/commit-timing/commit-timing-v1.xml", [])
    }
}
#endif
...
public enum PointerWarp {
    ...
    public enum V1 {
        // wayland_protocol!("./protocols/staging/pointer-warp/pointer-warp-v1.xml", [])
    }
}
#endif